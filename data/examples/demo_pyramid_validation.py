...
def run_demo():
    """Run an interactive demo of the 4-star pyramid validation."""
    print("Running 4-Star Pyramid Validation Demo...")
    ...
    # 2. Create 4-star catalog
    catalog = catalog_builder.create_pyramid_catalog()
